...
const CustomDialog = (props: DialogProps) => {
    ...
    return (
        <Dialog className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto}"
        ...
        >
            ...
            <Dialog.Overlay className="fixed inset-0 z-10 bg-black opacity-30"></Dialog.Overlay>
        </Dialog>
    );
};
